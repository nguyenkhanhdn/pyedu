  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row h-[calc(100vh-4rem)] overflow-hidden bg-slate-50 text-slate-800">
        ...
        <div className="p-4 border-b border-slate-200 bg-white/90 sticky top-0 z-10 space-y-2.5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-bold text-sm text-slate-900">Sổ Tay Ngoại Tuyến</h2>
            </div>
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto max-w-4xl space-y-6">
        ...
        <div className="p-3.5 rounded-2xl bg-emerald-50 border border-emerald-200 flex items-center justify-between text-xs text-emerald-800 shadow-xs">
          <div className="flex items-center gap-2">
